const Inbox = () => {
    return (
        <div className="flex flex-col gap-y-2 justify-center items-center h-full -mt-4">
            <div>
            ...
            <p className="text-sm text-light-text-secondary dark:text-dark-text-secondary">Bir arkadaşına veya gruba gizli fotoğraflar ve mesajlar gönder</p>
            <button className="text-sm text-white font-semibold bg-blue-500 hover:bg-blue-600 px-4 py-1.5 rounded-lg cursor-pointer transition duration-200">Mesaj gönder</button>
        </div>
    )
}
