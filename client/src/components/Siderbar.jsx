...
import { FiSettings, FiBookmark, FiMoon, FiFlag, FiLogOut, FiUser } from "react-icons/fi";
...
const Siderbar = () => {
    ...
    const menuItems = [
        {
            name: "Ana Sayfa",
            icon: (
                <svg aria-label="Ana Sayfa" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Ana Sayfa</title><path d="M9.005 16.545a2.997 2.997 0 0 1 2.997-2.997A2.997 2.997 0 0 1 15 16.545V22h7V11.543L12 2 2 11.543V22h7.005Z" fill="none" stroke="currentColor" strokeLinejoin="round" strokeWidth="2"></path></svg>
            ),
            link: "/"
        },
        {
            name: "Ara",
            icon: (
                <svg aria-label="Ara" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Ara</title><path d="M19 10.5A8.5 8.5 0 1 1 10.5 2a8.5 8.5 0 0 1 8.5 8.5Z" fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></path><line fill="none" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" x1="16.511" x2="22" y1="16.511" y2="22"></line></svg>
            ),
            link: "/search"
        },
        {
            name: "Keşfet",
            icon: (
                <svg aria-label="Keşfet" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Keşfet</title><polygon fill="none" points="13.941 13.953 7.581 16.424 10.06 10.056 16.42 7.585 13.941 13.953" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></polygon><polygon fillRule="evenodd" points="10.06 10.056 13.949 13.945 7.581 16.424 10.06 10.056"></polygon><circle cx="12.001" cy="12.005" fill="none" r="10.5" stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"></circle></svg>
            ),
            link: "/explore"
        },
        {
        ...
        },
        {
            name: "Bildirimler",
            icon: (
                <svg aria-label="Bildirimler" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img" viewBox="0 0 24 24" width="24"><title>Bildirimler</title><path d="M16.792 3.904A4.989 4.989 0 0 1 21.5 9.122c0 3.072-2.652 4.959-5.197 7.222-2.512 2.243-3.865 3.469-4.303 3.752-.477-.309-2.143-1.823-4.303-3.752C5.141 14.072 2.5 12.167 2.5 9.122a4.989 4.989 0 0 1 4.708-5.218 4.21 4.21 0 0 1 3.675 1.941c.84 1.175.98 1.763 1.12 1.763s.278-.588 1.11-1.766a4.17 4.17 0 0 1 3.679-1.938m0-2a6.04 6.04 0 0 0-4.797 2.127 6.052 6.052 0 0 0-4.787-2.127A6.985 6.985 0 0 0 .5 9.122c0 3.61 2.55 5.827 5.015 7.97.283.246.569.494.853.747l1.027.918a44.998 44.998 0 0 0 3.518 3.018 2 2 0 0 0 2.174 0 45.263 45.263 0 0 0 3.626-3.115l.922-.824c.293-.26.59-.519.885-.774 2.334-2.025 4.98-4.32 4.98-7.94a6.985 6.985 0 0 0-6.708-7.218Z"></path></svg>
            ),
            link: "/notifications",
            notificaion: true
        },
    ...
    return (
        <div className="p-3 h-full fixed w-[17.65%] max-lg:w-[74px] relavite z-50">

            {/* Instagram Logo */}
            <div className="mt-4 mb-6 p-3 flex flex-col justify-center max-lg:items-center max-lg:mb-0">
                <Link to="/">
                    ...
                    <div className="hidden max-lg:inline-block rounded-md hover:bg-light-hover dark:hover:bg-dark-hover p-3 transition-all duration-300 hover:scale-105">
            ...
            {/* Sidebar main items */}
            <div className="flex flex-col justify-center max-lg:items-center gap-y-2">
                {menuItems.map((item, index) => (
                    <div key={index}>
                        <NavLink to={item.link}
                            className={({ isActive }) => isActive ? "flex items-center gap-x-4 hover:bg-light-hover dark:hover:bg-dark-hover p-3 rounded-md transition-all duration-300 group font-semibold relative" : "relative flex items-center gap-x-4 hover:bg-light-hover dark:hover:bg-dark-hover p-3 rounded-md transition-all duration-300 group"}>
                            <span className="group-hover:scale-105 transition-all duration-300">{item.icon ? item.icon : <img className="w-6 h-6 rounded-full object-cover border-2" src={item.image} />}</span>
                            <span className="max-lg:hidden"> {item.name} </span>
                            {notification && item.notificaion && <div className="w-3 h-3 bg-rose-500 rounded-full absolute left-[1.6rem] top-3"></div>}
                        </NavLink>
                    </div>
                ))}
            </div>
            ...
            <div className="flex gap-x-4 mt-76 p-3 rounded-md transition-all duration-300 group cursor-pointer relative hover:bg-light-hover dark:hover:bg-dark-hover" onClick={toggleMenu}>
                ...
                {/* Dropdown menü */}
                {isOpen && (
                    <div className="absolute bottom-full mb-3 w-64 rounded-2xl shadow-lg p-4 z-20 bg-light-bg dark:bg-dark-bg-secondary">
                        <div className="flex flex-col">
                            <MenuItem icon={<FiSettings />} text="Ayarlar" onClick={handleSettingsClick} />
                            <MenuItem icon={<MdOutlineHistory />} text="Hareketlerin" />
...
const MenuItem = ({ icon, text, onClick }) => (
    <div onClick={onClick} className="flex items-center gap-x-3 px-3 py-2 my-1 hover:bg-light-hover hover:dark:bg-dark-dropdown-bg-hover rounded-md cursor-pointer transition-all">
