...
const HomePage = () => {
    ...
    const handleName = (e) => {
        ...
        setName(newName)
        disabledHandle(newName, password)
    }
    ...
    const disabledHandle = (newName, newPassword) => {
        if (newName.length > 0 && newPassword.length > 5) {
            setDisabled(false)
        } else {
            setDisabled(true)
        }
                ...
                <div className='flex '>
                    ...
                    <div className='text-center'>
                            ...
                            <form action="" className='flex flex-col mt-10'>
                                ...
                                </label>
                                {
                                    disabled ? (
                                        ...
                                        <button type='submit' className='text-white bg-[#4DB5F9] hover:bg-[#1877F2] rounded-lg py-1 my-1'>Giriş yap</button>
                                    )
                                }
                        ...
                        <div className='border h-16 flex justify-center items-center mt-2'>
                            <span className='text-sm'>Hesabın yok mu? <a href="/" className='text-sky-600'>Kaydol</a></span>
                        </div>
