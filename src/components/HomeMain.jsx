...
const HomeMain = () => {
    return (
        <div className="flex mt-[3.15rem] mx-auto px-40">

            <div className="text-center text-xs w-[69.7%]">
                <div className="hikayeler flex gap-[1.29rem] justify-center items-center">
                ...
                <div className="w-[60%] flex flex-col mx-auto h-[550px] mt-6">
                ...
                <div className="bg-red-500 w-[60%] flex justify-center items-center mx-auto h-[550px] mt-6">
            ...
            <div className="w-[285px] text-sm mt-2">
